    ...
    return(
        <nav className="bg-white border-b-1 border-gray-300">
            <ul className="list-style-none flex justify-end">
                ...
                <li className="p-4 px-8 uppercase hover:cursor-pointer hover:text-blue-700">English</li>
                <li className="p-4 px-8 uppercase hover:cursor-pointer hover:text-blue-700">Съобщения</li>
                <li className="p-4 px-8 uppercase hover:cursor-pointer hover:text-blue-700">Известия</li>
                ...
                <li className="border-l-1 border-gray-300 p-4 px-8 uppercase hover:cursor-pointer hover:text-blue-700">Профил</li>
                <li className="border-l-1 border-gray-300 p-4 px-8 uppercase hover:cursor-pointer hover:text-blue-700">Изход</li>
            </ul>
        </nav>
    )
}