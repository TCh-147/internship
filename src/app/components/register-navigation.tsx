...
export default function RegisterNav(){
    ...
    return(
        ...
        <ul className="list-none grid w-full grid-cols-7 justify-between text-base">
          ...
          <li className="justify-self-center self-center p-2"><button className="p-2 px-4 uppercase text-sm bg-gray-200 hover:cursor-pointer hover:bg-blue-900 hover:text-white"><Link className="p-2 px-4" href="/">Вход</Link></button></li>
        </ul>
      </nav>
    )
}